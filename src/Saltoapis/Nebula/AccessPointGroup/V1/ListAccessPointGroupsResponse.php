 ...
 *
 * Generated from protobuf message <code>salto.nebula.accesspointgroup.v1.ListAccessPointGroupsResponse</code>
 */
class ListAccessPointGroupsResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        return $this->access_point_groups;
    }
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Saltoapis\Nebula\AccessPointGroup\V1\AccessPointGroup::class);
        $this->access_point_groups = $arr;
