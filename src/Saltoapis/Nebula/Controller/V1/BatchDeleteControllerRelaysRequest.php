 ...
 *
 * Generated from protobuf message <code>salto.nebula.controller.v1.BatchDeleteControllerRelaysRequest</code>
 */
class BatchDeleteControllerRelaysRequest extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Saltoapis\Nebula\Controller\V1\DeleteControllerRelayRequest::class);
        $this->requests = $arr;
