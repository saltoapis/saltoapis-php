 ...
 *
 * Generated from protobuf message <code>salto.nebula.electroniclock.v1.GetElectronicLockRequest</code>
 */
class GetElectronicLockRequest extends \Google\Protobuf\Internal\Message
{
    /**
