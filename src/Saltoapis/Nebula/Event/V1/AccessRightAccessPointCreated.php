 ...
 *
 * Generated from protobuf message <code>salto.nebula.event.v1.AccessRightAccessPointCreated</code>
 */
class AccessRightAccessPointCreated extends \Google\Protobuf\Internal\Message
{
    /**
