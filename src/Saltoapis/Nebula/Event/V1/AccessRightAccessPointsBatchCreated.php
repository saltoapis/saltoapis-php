 ...
 *
 * Generated from protobuf message <code>salto.nebula.event.v1.AccessRightAccessPointsBatchCreated</code>
 */
class AccessRightAccessPointsBatchCreated extends \Google\Protobuf\Internal\Message
{
    /**
